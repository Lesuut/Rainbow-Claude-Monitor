...
│  Rainbow Claude Monitor                     ☀ ─●─ ☾      │
│                                                          │
│      ( CPU 34% )       ( RAM 61% )      i7-12700 · 20c   │
│                                                          │
│  ● Personal 1       ● Personal 2      ● Work             │
│  5H ▓▓▓▓▓░░░ 62%    5H ▓▓▓▓▓▓▓▓ 97%   5H ░░░░░░░░  0%    │
│  WK ▓▓░░░░░░ 21%    WK ▓▓▓▓▓░░░ 55%   WK ▓░░░░░░░  8%    │
│  ⣾ работает         ждёт ввода        [ Launch ]         │
└──────────────────────────────────────────────────────────┘
```
...
| | |
|---|---|
| **Лимиты** | 5-часовое и недельное окно на аккаунт, проценты, время сброса, подпись «свободно» после сброса |
| **Живой статус** | видит запущенные сессии Claude Code: `работает` / `ждёт ввода`, мигает при переходе в «готово» |
| **Железо** | CPU %, RAM %, модель процессора, ядра, uptime, число процессов |
